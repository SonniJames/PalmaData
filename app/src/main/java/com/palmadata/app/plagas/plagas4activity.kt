...
import com.palmadata.app.databinding.ActivityPlagas4Binding

class Plagas4Activity : AppCompatActivity() {
    private lateinit var binding: ActivityPlagas4Binding
    private var valorActual = ""
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPlagas4Binding.inflate(layoutInflater)
        ...
        binding.btnAccion.setOnClickListener {
            when {
                ...
                valorActual.length > 3 -> mostrarError("LÍNEA debe tener máximo 3 dígitos")
                else -> startActivity(Intent(this, Plagas5Activity::class.java).also {
                    ...
                    it.putExtra("lectura", lectura); it.putExtra("linea", valorActual)
                })
            }
        }
    }
