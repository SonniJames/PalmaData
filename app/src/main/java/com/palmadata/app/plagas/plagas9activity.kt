...
import com.palmadata.app.databinding.ActivityPlagas9Binding

class Plagas9Activity : AppCompatActivity() {
    private lateinit var binding: ActivityPlagas9Binding
    private var valorActual = ""
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPlagas9Binding.inflate(layoutInflater)
        ...
        binding.btnAccion.setOnClickListener {
            startActivity(Intent(this, Plagas10Activity::class.java).also {
                ...
                it.putExtra("cantidad", cantidad); it.putExtra("niv_foliar", valorActual.ifEmpty { "0" })
            })
        }
    }
