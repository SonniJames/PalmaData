...
import com.palmadata.app.databinding.ActivityPlagas5Binding

class Plagas5Activity : AppCompatActivity() {
    private lateinit var binding: ActivityPlagas5Binding
    private var valorActual = ""
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPlagas5Binding.inflate(layoutInflater)
        ...
        binding.btnAccion.setOnClickListener {
            when {
                ...
                valorActual.length > 2 -> mostrarError("PALMA debe tener máximo 2 dígitos")
                else -> startActivity(Intent(this, Plagas6Activity::class.java).also {
                    ...
                    it.putExtra("lectura", lectura); it.putExtra("linea", linea); it.putExtra("palma", valorActual)
                })
            }
        }
    }
