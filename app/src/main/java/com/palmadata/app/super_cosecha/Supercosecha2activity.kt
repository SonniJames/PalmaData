...
import com.palmadata.app.databinding.ActivitySuperCosecha2Binding
import com.palmadata.app.ui.WorkerAdapter
import com.palmadata.app.utils.DatabaseHelper

class SuperCosecha2Activity : AppCompatActivity() {
    private lateinit var binding: ActivitySuperCosecha2Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySuperCosecha2Binding.inflate(layoutInflater)
        ...
        val adapter = WorkerAdapter { nombre ->
            ...
            startActivity(Intent(this, SuperCosecha3Activity::class.java).also {
