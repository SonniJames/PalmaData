...
import com.palmadata.app.databinding.ActivitySuperCosecha0Binding
import com.palmadata.app.ui.WorkerAdapter
import com.palmadata.app.utils.DatabaseHelper

class SuperCosecha0Activity : AppCompatActivity() {
    private lateinit var binding: ActivitySuperCosecha0Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySuperCosecha0Binding.inflate(layoutInflater)
        ...
        val adapter = WorkerAdapter { nombre ->
            ...
            startActivity(Intent(this, SuperCosecha1Activity::class.java).also {
