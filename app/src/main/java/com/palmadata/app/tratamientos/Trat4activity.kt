...
import com.palmadata.app.databinding.ActivityTrat4Binding

class Trat4Activity : AppCompatActivity() {
    private lateinit var binding: ActivityTrat4Binding
    private var valorActual = ""
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTrat4Binding.inflate(layoutInflater)
        ...
        binding.btnAccion.setOnClickListener {
            when {
                ...
                valorActual.length > 2 -> mostrarError("PALMA debe tener máximo 2 dígitos")
                    ...
                    val i = Intent(this, Trat5Activity::class.java)
