...
/**
 * Pantalla 4 — LÍNEA. Compartida por los dos flujos: lo único que cambia es
 * el texto del botón (a dónde va después), según el modo elegido en la 3.
 * Restricciones: obligatoria, de 1 a 3 dígitos.
 */
class SuperPoli4Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvTitulo.text = "LÍNEA"
        binding.btnAccion.text =
            if (modo == SuperPoli3Activity.MODO_LINEA_PALMA) "PALMA" else "CANTIDAD PALMAS"
        ...
        binding.btnAccion.setOnClickListener {
            when {
                ...
                else -> startActivity(Intent(this, SuperPoli5Activity::class.java).also {
