...
import com.palmadata.app.databinding.ActivitySuperPoli2Binding
import com.palmadata.app.ui.WorkerAdapter
import com.palmadata.app.utils.DatabaseHelper

class SuperPoli2Activity : AppCompatActivity() {
    private lateinit var binding: ActivitySuperPoli2Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySuperPoli2Binding.inflate(layoutInflater)
        ...
        val adapter = WorkerAdapter { nombre ->
            ...
            startActivity(Intent(this, SuperPoli3Activity::class.java).also {
