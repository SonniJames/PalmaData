...
import com.palmadata.app.databinding.ActivitySuperPoli1Binding
import com.palmadata.app.ui.WorkerAdapter
import com.palmadata.app.utils.DatabaseHelper

class SuperPoli1Activity : AppCompatActivity() {
    private lateinit var binding: ActivitySuperPoli1Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySuperPoli1Binding.inflate(layoutInflater)
        ...
        val adapter = WorkerAdapter { nombre ->
            ...
            startActivity(Intent(this, SuperPoli2Activity::class.java).also {
