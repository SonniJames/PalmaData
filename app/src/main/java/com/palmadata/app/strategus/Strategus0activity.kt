...
import com.palmadata.app.databinding.ActivityStrategus0Binding
import com.palmadata.app.ui.WorkerAdapter
import com.palmadata.app.utils.DatabaseHelper

class Strategus0Activity : AppCompatActivity() {
    private lateinit var binding: ActivityStrategus0Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityStrategus0Binding.inflate(layoutInflater)
        ...
        val adapter = WorkerAdapter { nombre ->
            ...
            startActivity(Intent(this, Strategus1Activity::class.java).also {
