...
import com.palmadata.app.databinding.ActivityStrategus4Binding

class Strategus4Activity : AppCompatActivity() {
    private lateinit var binding: ActivityStrategus4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnAccion.setOnClickListener {
            when {
                ...
                else -> startActivity(Intent(this, Strategus5Activity::class.java).also {
