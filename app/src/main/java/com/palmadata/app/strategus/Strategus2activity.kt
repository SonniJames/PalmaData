...
class Strategus2Activity : AppCompatActivity() {
    private lateinit var binding: ActivityStrategus2Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityStrategus2Binding.inflate(layoutInflater)
