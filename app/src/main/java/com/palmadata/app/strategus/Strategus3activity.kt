...
import com.palmadata.app.databinding.ActivityStrategus3Binding

class Strategus3Activity : AppCompatActivity() {
    private lateinit var binding: ActivityStrategus3Binding
    private var valorActual = ""
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityStrategus3Binding.inflate(layoutInflater)
        ...
        binding.btnAccion.setOnClickListener {
            ...
            startActivity(Intent(this, Strategus4Activity::class.java).also {
