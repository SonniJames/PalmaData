...
import com.palmadata.app.databinding.ActivityTrampas1Binding

class Trampas1Activity : AppCompatActivity() {
    private lateinit var binding: ActivityTrampas1Binding
    private var valorActual = ""
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTrampas1Binding.inflate(layoutInflater)
        ...
        binding.btnAccion.setOnClickListener {
            ...
            startActivity(Intent(this, Trampas2Activity::class.java).also {
