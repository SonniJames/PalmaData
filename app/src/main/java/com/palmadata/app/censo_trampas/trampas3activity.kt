...
import com.palmadata.app.databinding.ActivityTrampas3Binding

class Trampas3Activity : AppCompatActivity() {
    private lateinit var binding: ActivityTrampas3Binding
    private var valorActual = ""
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTrampas3Binding.inflate(layoutInflater)
        ...
        binding.btnAccion.setOnClickListener {
            startActivity(Intent(this, Trampas4Activity::class.java).also {
                ...
                it.putExtra("machos", valorActual.ifEmpty { "0" })
            })
        }
    }
