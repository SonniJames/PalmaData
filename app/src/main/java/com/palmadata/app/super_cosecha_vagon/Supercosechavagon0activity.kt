...
import com.palmadata.app.databinding.ActivitySuperCosechaVagon0Binding
import com.palmadata.app.ui.WorkerAdapter
import com.palmadata.app.utils.DatabaseHelper

class SuperCosechaVagon0Activity : AppCompatActivity() {
    private lateinit var binding: ActivitySuperCosechaVagon0Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySuperCosechaVagon0Binding.inflate(layoutInflater)
        ...
        val adapter = WorkerAdapter { nombre ->
            ...
            startActivity(Intent(this, SuperCosechaVagon1Activity::class.java).also {
