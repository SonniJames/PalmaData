...
import com.palmadata.app.databinding.ActivitySuperCosechaVagon2Binding
import com.palmadata.app.ui.WorkerAdapter
import com.palmadata.app.utils.DatabaseHelper

class SuperCosechaVagon2Activity : AppCompatActivity() {
    private lateinit var binding: ActivitySuperCosechaVagon2Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySuperCosechaVagon2Binding.inflate(layoutInflater)
        ...
        val adapter = WorkerAdapter { nombre ->
            ...
            startActivity(Intent(this, SuperCosechaVagon3Activity::class.java).also {
