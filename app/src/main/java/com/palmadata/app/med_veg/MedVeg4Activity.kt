...
import com.palmadata.app.databinding.ActivityMedVeg4Binding

/** Pantalla 4 — LÍNEA. Teclado numérico; obligatorio (1 a 3 dígitos). */
class MedVeg4Activity : AppCompatActivity() {

    private lateinit var binding: ActivityMedVeg4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMedVeg4Binding.inflate(layoutInflater)
    ...
    private fun siguiente() {
        startActivity(Intent(this, MedVeg5Activity::class.java).also {
    ...
    /** Reutilizada por CLEAR_TOP | SINGLE_TOP al volver aquí: se limpia el valor. */
