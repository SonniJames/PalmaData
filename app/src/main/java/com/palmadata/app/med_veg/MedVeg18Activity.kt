...
import com.palmadata.app.databinding.ActivityMedVeg18Binding

/** Pantalla 18 — HOJAS VERDES. Teclado numérico; opcional (vacío = NULL). */
class MedVeg18Activity : AppCompatActivity() {

    private lateinit var binding: ActivityMedVeg18Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMedVeg18Binding.inflate(layoutInflater)
    ...
    private fun siguiente() {
        startActivity(Intent(this, MedVeg19Activity::class.java).also {
            intent.extras?.let { e -> it.putExtras(e) }
            it.putExtra("hojas_verdes", valorActual)
        })
    }
