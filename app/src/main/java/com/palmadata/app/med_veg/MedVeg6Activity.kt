...
import com.palmadata.app.databinding.ActivityMedVeg6Binding

/** Pantalla 6 — NÚMERO DE FOLIOLOS. Teclado numérico; opcional (vacío = NULL). */
class MedVeg6Activity : AppCompatActivity() {

    private lateinit var binding: ActivityMedVeg6Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMedVeg6Binding.inflate(layoutInflater)
    ...
    private fun siguiente() {
        startActivity(Intent(this, MedVeg7Activity::class.java).also {
            intent.extras?.let { e -> it.putExtras(e) }
            it.putExtra("num_foliolos", valorActual)
        })
    }
