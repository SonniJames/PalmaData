...
import com.palmadata.app.databinding.ActivityMedVeg2Binding
import com.palmadata.app.ui.WorkerAdapter
import com.palmadata.app.utils.DatabaseHelper

class MedVeg2Activity : AppCompatActivity() {

    private lateinit var binding: ActivityMedVeg2Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMedVeg2Binding.inflate(layoutInflater)
        ...
        val adapter = WorkerAdapter { nombreSeleccionado ->
            ...
            val nextIntent = Intent(this, MedVeg3Activity::class.java)
