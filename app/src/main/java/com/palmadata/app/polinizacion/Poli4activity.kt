...
import com.palmadata.app.databinding.ActivityPoli4Binding

class Poli4Activity : AppCompatActivity() {
    private lateinit var binding: ActivityPoli4Binding
    private var valorActual = ""
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPoli4Binding.inflate(layoutInflater)
        ...
        binding.btnAccion.setOnClickListener {
            when {
                ...
                else -> startActivity(Intent(this, Poli5Activity::class.java).also {
