...
import com.palmadata.app.databinding.ActivityPoli2Binding
import com.palmadata.app.ui.WorkerAdapter
import com.palmadata.app.utils.DatabaseHelper

class Poli2Activity : AppCompatActivity() {
    private lateinit var binding: ActivityPoli2Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPoli2Binding.inflate(layoutInflater)
        ...
        val adapter = WorkerAdapter { nombre ->
            ...
            startActivity(Intent(this, Poli3Activity::class.java).also {
