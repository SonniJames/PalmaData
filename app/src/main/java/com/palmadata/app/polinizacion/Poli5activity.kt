...
import com.palmadata.app.databinding.ActivityPoli5Binding

class Poli5Activity : AppCompatActivity() {
    private lateinit var binding: ActivityPoli5Binding
    private var valorActual = ""
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPoli5Binding.inflate(layoutInflater)
        ...
        binding.btnAccion.setOnClickListener {
            when {
                ...
                else -> startActivity(Intent(this, Poli6Activity::class.java).also {
