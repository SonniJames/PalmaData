...
import com.palmadata.app.databinding.ActivityPoli1Binding
import com.palmadata.app.ui.WorkerAdapter
import com.palmadata.app.utils.DatabaseHelper

class Poli1Activity : AppCompatActivity() {
    private lateinit var binding: ActivityPoli1Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPoli1Binding.inflate(layoutInflater)
